		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Materiaal",
									"targetURL": "#apbemateriaal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apbemateriaal-display": {
								"semanticObject": "apbemateriaal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ap.be.materiaal",
									"url": sap.ui.require.toUrl("ap/be/materiaal")
								}
							}
						}
					}
